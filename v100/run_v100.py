...
os.mkdir(energy_densenet169)
os.chdir(energy_densenet169)
subprocess.run(["cmake",".."])
subprocess.run(["make","-j"])

if os.path.exists(energy_densenet169_cusnn):
    shutil.rmtree(energy_densenet169_cusnn)
os.mkdir(energy_densenet169_cusnn)
os.chdir(energy_densenet169_cusnn)
subprocess.run(["cmake",".."])
subprocess.run(["make","-j"])

if os.path.exists(energy_densenet201):
    shutil.rmtree(energy_densenet201)
os.mkdir(energy_densenet201)
os.chdir(energy_densenet201)
subprocess.run(["cmake",".."])
subprocess.run(["make","-j"])
...
os.mkdir(energy_densenet201_cusnn)
os.chdir(energy_densenet201_cusnn)
subprocess.run(["cmake",".."])
subprocess.run(["make","-j"])

if os.path.exists(energy_resnet50):
    shutil.rmtree(energy_resnet50)
os.mkdir(energy_resnet50)
os.chdir(energy_resnet50)
subprocess.run(["cmake",".."])
subprocess.run(["make","-j"])

if os.path.exists(energy_resnet50_cusnn):
    shutil.rmtree(energy_resnet50_cusnn)
os.mkdir(energy_resnet50_cusnn)
os.chdir(energy_resnet50_cusnn)
subprocess.run(["cmake",".."])
subprocess.run(["make","-j"])

if os.path.exists(energy_resnet152):
    shutil.rmtree(energy_resnet152)
os.mkdir(energy_resnet152)
os.chdir(energy_resnet152)
subprocess.run(["cmake",".."])
subprocess.run(["make","-j"])
...
os.mkdir(energy_resnet152_cusnn)
...
print('starting evaluate densenet169 energy consumption(cuDNN), unit is milli-joule(mj)...')
os.chdir(energy_densenet169)
subprocess.run(["./test","../../../../sample_images/"])
print('starting evaluate densenet169 energy consumption(cuSNN), unit is milli-joule(mj)...')
os.chdir(energy_densenet169_cusnn)
subprocess.run(["./test","../../../../sample_images/"])
print('starting evaluate densenet201 energy consumption(cuDNN), unit is milli-joule(mj)...')
os.chdir(energy_densenet201)
subprocess.run(["./test","../../../../sample_images/"])
print('starting evaluate densenet201 energy consumption(cuSNN), unit is milli-joule(mj)...')
os.chdir(energy_densenet201_cusnn)
subprocess.run(["./test","../../../../sample_images/"])
print('starting evaluate resnet50 energy consumption(cuDNN), unit is milli-joule(mj)...')
os.chdir(energy_resnet50)
subprocess.run(["./test","../../../../sample_images/"])
print('starting evaluate resnet50 energy consumption(cuSNN), unit is milli-joule(mj)...')
os.chdir(energy_resnet50_cusnn)
subprocess.run(["./test","../../../../sample_images/"])
print('starting evaluate resnet152 energy consumption(cuDNN), unit is milli-joule(mj)...')
os.chdir(energy_resnet152)
subprocess.run(["./test","../../../../sample_images/"])
...
os.chdir(energy_vgg16)
subprocess.run(["./test","../../../../sample_images/"])
print('starting evaluate vgg16 energy consumption(cuSNN), unit is milli-joule(mj)...')
os.chdir(energy_vgg16_cusnn)
subprocess.run(["./test","../../../../sample_images/"])
print('starting evaluate vgg19 energy consumption(cuDNN), unit is milli-joule(mj)...')
os.chdir(energy_vgg19)
subprocess.run(["./test","../../../../sample_images/"])
